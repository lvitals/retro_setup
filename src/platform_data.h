...
typedef struct {
    ...
    char fallback_core_config_name[128];
    char fallback_core_options[512];
    char fallback_frontend_options[512];
    char extensions[128];
    char bios_files[256];
    char bios_extensions[128];
    char bios_copy_extensions[128];
    char bios_install_directory[256];
